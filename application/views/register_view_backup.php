...
<form method="post" action="<?php echo base_url() ?>register/validation">
	...
	<div class="field">
	  ...
	  <div class="control has-icons-left has-icons-right">
	    <input class="input" type="text" name="email" value="<?php echo set_value('email'); ?>" placeholder="e.g. xyz@ggmail.com">
	...
	<div class="field is-grouped">
	  <div class="control">
	    <input type="submit" name="form" "value="register" class="button is-link">
	  </div>
	  <div class="control">
